...
type TemplateServiceClient interface {
	Test(ctx context.Context, in *TemplateData, opts ...grpc.CallOption) (*TemplateResult, error)
}
...
func (c *templateServiceClient) Test(ctx context.Context, in *TemplateData, opts ...grpc.CallOption) (*TemplateResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TemplateResult)
	err := c.cc.Invoke(ctx, TemplateService_Test_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TemplateServiceServer interface {
	Test(context.Context, *TemplateData) (*TemplateResult, error)
}
...
func (UnimplementedTemplateServiceServer) Test(context.Context, *TemplateData) (*TemplateResult, error) {
...
func _TemplateService_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TemplateService_Test_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServiceServer).Test(ctx, req.(*TemplateData))
	}
